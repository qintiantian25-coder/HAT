...
class HAT(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3, embed_dim=96,
                 ...
                 use_checkpoint=False, upscale=2, img_range=1., upsampler='', resi_connection='1conv', **kwargs):
        ...
        for i_layer in range(self.num_layers):
            layer = RHAG(
                ...
                downsample=None, use_checkpoint=use_checkpoint, img_size=img_size, patch_size=patch_size,
